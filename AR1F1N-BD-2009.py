# DECRYPTED BY ARIFIN
# Github : https://github.com/iam.arifinrashid
 #!/usr/bin/python
# -*- coding: utf-8
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : ARIFIN RASHID'
    print 'FACEBOOK : facebook.com/iam.arifinrashid'
    print 'GITHUB     : github.com/fakearifin'
    print ''
    print 50* '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[ARIFIN-BRO]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
